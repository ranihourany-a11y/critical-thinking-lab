/**
 * Client-safe shared types and constants for Critical Thinking Lab.
 * This file contains NO server dependencies, NO fixtures, and NO seed data.
 */
...
/**
 * Client-safe default rubric configuration for activity authoring wizard.
 * Provides generic, pedagogically sound 5-level criteria without leaking activity-specific seed descriptors.
 */
export const DEFAULT_RUBRIC_CONFIG: RubricCriterion[] = [
  {
